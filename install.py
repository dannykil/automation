...
with open('./conf/config.json', 'r') as f:
    after = json.load(f)
# print(after)
# print(after["installed"])

if after["installed"] == "N":
    ...
    if text == "Y":
        after["user"] = "홍길동"
        after["account"] = "kdhong@hist.co.kr"
        after["password"] = "5678"
        after["filepath"] = "/user/kdhong/download/"
        after["filename"] = "/sample.xlsx"
        after["installed"] = "N"
